...
public class Input implements Initializable, Updatable {
	...
	public void update() {
		...
		this.prevMousePosition = new Vector2d(mousePosition);
		this.mousePosition = new Vector2d(cursorPosCallback.getPosition());
	}
	...
	public float getAxis(String name) {
		...
		if (axis instanceof KeyButtonAxis) {
			KeyButtonAxis keyButtonAxis = (KeyButtonAxis) axis;
		...
		} else if (axis instanceof MouseMovementAxis) {
			MouseMovementAxis mouseMovementAxis = (MouseMovementAxis) axis;
